...
{
    /***
     * Credit: Dr. James McCaffrey
     * Test Run - Matrix Inversion Using C#
     * -https://msdn.microsoft.com/en-us/magazine/mt736457.aspx
     * July 2016
     * Dr. James McCaffrey works for Microsoft Research in Redmond, Wash. 
     * He has worked on several Microsoft products including Internet Explorer and Bing. 
     * Dr. McCaffrey can be reached at jammc@microsoft.com.     
     ***/
    class MatrixHelper
    {
        public MatrixHelper()
      ...
      double[][] matrixB)
        ...
        double[][] ExtractLower(double[][] lum)
        {
        ...
        double[][] ExtractUpper(double[][] lum)
        {
        ...
        public double[][] MatrixAdd(double[][] matrixA, double[][] matrixB)
        {
            ...
            double[][] matrixResult = MatrixCreate(rows, cols);
            for (int i = 0; i<rows; i++)
        ...
        public double[][] MatrixSubtract(double[][] matrixA, double[][] matrixB)
        {
            int rows = matrixA.Length;
            int cols = matrixA[0].Length;
            double[][] matrixResult = MatrixCreate(rows, cols);
